...
plt.title(f'Thermolysin Intensity / sigma values in P6122 symmetry: 4.133 Å (3 keV)')
plt.xlabel('Dataset')
plt.ylabel('Anomalous density peaks')
plt.xticks(rotation=0)
for container in ax.containers:
    ax.bar_label(container)
plt.savefig('/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_2/plots/3p0_I_over_sigma.png')
plt.show()
...
plt.title(f'Thermolysin Overall R-merge values in P6122 symmetry: 4.133 Å (3 keV)')
plt.xlabel('Dataset')
plt.ylabel('Anomalous density peaks')
plt.xticks(rotation=0)
for container in ax2.containers:
    ax2.bar_label(container)
plt.savefig('/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_2/plots/3p0_rmerges.png')
plt.show()