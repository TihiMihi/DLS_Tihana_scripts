...
plt.title(f'Thermolysin Intensity / sigma values in P6122 symmetry: 3.263 Å (3.8 keV)')
plt.xlabel('Dataset')
...
plt.title(f'Thermolysin Overall R-merge values in P6122 symmetry: 3.263 Å (3.8 keV)')
plt.xlabel('Dataset')
plt.ylabel('R-merge')
plt.xticks(rotation=0)
