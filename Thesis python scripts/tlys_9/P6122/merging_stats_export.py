...
anacor_path = '/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_9/P6122/anacor'
dials_path  = '/dls/science/users/icf19162/anacor/thermolysin/tlys_9/dials_for_anacor/P6122_dials_for_anacor'
csv_path    = '/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_9/P6122/csvs'

data_list = []
for dataset_path in os.listdir(anacor_path):
    if os.path.isdir(os.path.join(anacor_path, dataset_path)) is True and dataset_path != '3p0_9':
