...
single_pth='/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_2/P1/merged_data/dimple'
prefix='auto'
data_list=[]
...
for dir_pth in (dataset_list):#'SD_A:MET122', 
    ...
    for target in ['acsh','sh', 'ac']:
        ...
        dataset_filename = f'/dls/i23/data/2024/cm37273-1/processing/tihana/tlys_2/P1/peaks_csvs/{dir_pth}_peaks.csv'.format(target)
