...
The absence of smoothly-changing behaviour between experiments is a limitation for finding the optimal absorption coefficients, as we cannot coroborate the optimal $R$ factor.%the R-factor cannot corroborate the optimal $I/\sigma(I)$.
