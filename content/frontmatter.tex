...
\rhead{\thepage}
\cfoot{}
\rfoot{20\textsuperscript{th} April, 2024 }
...
\begin{abstract}
    ...
    While I23 is a specialised beamline for operating in-vacuum to provide high signal-to-noise ratios at the longest wavelengths, low-energy diffraction is still hindered by drastic absorption effects that must be accounted for from the samples themselves, as standard correction methods are insufficient. In response, I23 operates an X-ray tomography camera to reconstruct a 3D model of samples, allowing for the calculation of X-ray path lengths to determine analytical absorption factors.
    This project explores the effects of tomography-based reconstructions for absorption corrections and its applications in further experiments at I23. This approach was combined with laser-shaping to assess the effects of combining two independent techniques of absorption correction.

    Here, we show that tomography-based analytical absorption corrections coupled with standard empirical corrections successfully enhance the diffraction quality of high-symmetry crystals. This effect was previously thought to be limited to low-symmetry crystals with low multiplicity. The implications of this is that analytical absorption coefficients may prove to be useful for a larger range of radiation-sensitive crytals, and not only those in low-symmetry groups. We also demonstrate the successes of the improved data quality of analytically-corrected reflections in a novel ion-identification experiment. Finally, we show that the effects of tomography-cased absorption corrections are comparable, if not better, to the effects of laser-shaping for absorption correction; however, there is no clear benefit in the combined effect of these independent correction techniques.
\end{abstract}
\newpage
